...
export const LINKS = [
  {
    ...
    description: 'New World Database contains all the information about items, quests, crafting recipes, perks, abilities, population numbers and much more',
    url: 'https://nwdb.info',
  },
  {
    name: 'New World Tools',
    description: 'Damage calculator for New World. Try out item, stat, and mastery combinations and see how much you\'d be hitting for.',
    url: 'https://www.nw-tools.info',
  },
  {
    name: 'gaming.tools',
    image: 'https://gaming.tools/newworld/images/trade-skills/armoring.png',
    description: 'Find the best crafting options to level up your trade skills, and most optimized crafting calculators for all craftable items in New World.',
  ...
  },
  {
    ...
    description: 'New World MMO Map - All Resources, Chests, Lore Documents, Essences, Boss farming spots & more! Use the progress tracker to get 100%!',
