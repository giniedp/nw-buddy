...
import { PlayerTitlesTableAdapter } from '~/widgets/data/player-titles-table'
...
@Component({
  ...
  providers: [
    provideDataView({
      adapter: PlayerTitlesTableAdapter,
    }),
...
export class PlayerTitlesPageComponent {
  protected title = 'Player Titles'
  protected filterParam = 'filter'
  protected selectionParam = 'id'
  protected persistKey = 'player-titles-table'
  ...
  public constructor(
    ...
    head.updateMetadata({
      url: head.currentUrl,
      title: 'New World - Player Titles DB',
    })
  }
}
