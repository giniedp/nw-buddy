...
import { SpellTableAdapter } from '~/widgets/data/spell-table'
...
export class SpellsPageComponent {
  protected title = 'Spells'
  protected filterParam = 'filter'
  protected selectionParam = 'id'
  protected persistKey = 'spells-table'
