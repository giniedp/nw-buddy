...
import { AbilitiesTableComponent } from '~/widgets/abilities-table'
...
export class AbilitiesComponent implements OnInit, OnChanges, OnDestroy {
  @ViewChild(AbilitiesTableComponent, { static: true })
  public table: AbilitiesTableComponent
