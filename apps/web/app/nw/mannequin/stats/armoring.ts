import { getArmorRatingElemental, getArmorRatingPhysical, statusEffectHasArmorFortifyCap } from '@nw-data/common'
...
export function selectModsArmor(db: DbSlice, mods: ActiveMods, state: MannequinState) {
  return {
    PhysicalArmor: selectModPhysicalArmor(db, mods, state),
    ElementalArmor: selectModElementalArmor(db, mods, state),
  }
}
