...
@Injectable()
export class QuestTableSource extends DataTableSource<QuestTableRecord> {
  ...
  public override entityCategories(item: Objective): DataTableCategory[] {
    if (!item.Type) {
      return null
    }
    return [
  ...
  public override gridOptions(): GridOptions<QuestTableRecord> {
