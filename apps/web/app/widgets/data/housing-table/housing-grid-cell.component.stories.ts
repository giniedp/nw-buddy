...
import { HousingGridCellComponent } from './housing-grid-cell.component'
...
@Component({
  ...
  imports: [CommonModule, VirtualGridComponent, VirtualGridCellDirective, HousingGridCellComponent],
  host: {
...
export class StoryComponent {
  ...
  protected gridOptions = HousingGridCellComponent.buildGridOptions()
}
