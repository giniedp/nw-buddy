...
export type QuestGridUtils = DataGridUtils<QuestGridRecord>
export type QuestGridRecord = Objective

export function questColIcon(util: QuestGridUtils) {
  return util.colDef({
    colId: 'icon',
...
export function questColObjectiveID(util: QuestGridUtils) {
  return util.colDef({
    colId: 'objectiveID',
...
export function questColTitle(util: QuestGridUtils) {
  return util.colDef({
    colId: 'title',
...
export function questColDescription(util: QuestGridUtils) {
  return util.colDef({
    colId: 'description',
...
export function questColPlayerPrompt(util: QuestGridUtils) {
  return util.colDef({
    colId: 'playerPrompt',
...
export function questColObjectiveProposalResponse(util: QuestGridUtils) {
  return util.colDef({
...
export function questColInProgressResponse(util: QuestGridUtils) {
  return util.colDef({
...
export function questColDestinationCompletionAvailablePrompt(util: QuestGridUtils) {
  return util.colDef({
...
export function questColDestinationCompletionAvailableResponse(util: QuestGridUtils) {
  return util.colDef({
...
export function questColDifficultyLevel(util: QuestGridUtils) {
  return util.colDef({
...
export function questColRequiredLevel(util: QuestGridUtils) {
  return util.colDef({
    colId: 'requiredLevel',
...
export function questColAchievementId(util: QuestGridUtils) {
  return util.colDef({
    colId: 'achievementId',
...
export function questColRequiredAchievementId(util: QuestGridUtils) {
  return util.colDef({
