...
@Injectable()
export class StatusEffectTableSource extends DataTableSource<StatusEffectTableRecord> {
  ...
  public override entityCategories(item: Statuseffect): DataTableCategory[] {
    return [
      {
        id: item['$source'],
        label: item['$source'],
  ...
  public override gridOptions(): GridOptions<StatusEffectTableRecord> {
