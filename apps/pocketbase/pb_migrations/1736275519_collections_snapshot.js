...
migrate((app) => {
  const snapshot = [
    ...
    },
    {
      ...
      "id": "pbc_1431517297",
      "indexes": [
        "CREATE INDEX `idx_1dOyDDp3k5` ON `skillbuilds` (`user`)"
      ],
      "listRule": "user.id = @request.auth.id",
      "name": "skillbuilds",
      "system": false,
    ...
    },
    {
      ...
      "indexes": [],
      "listRule": "",
      "name": "public_skillbuilds",
      "system": false,
      "type": "view",
      "updateRule": null,
      "viewQuery": "SELECT\n  skillbuilds.id as id,\n  skillbuilds.user as user,\n  skillbuilds.data as data\nFROM skillbuilds\nWHERE skillbuilds.status = 'public'",
      "viewRule": ""
    }
  ];
