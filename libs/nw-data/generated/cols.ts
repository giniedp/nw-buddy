...
export const COLS_CHARMFILTERDATA = {
  DisplayName: 'string',
  FilterId: 'string',
  ItemClass: 'string',
  SortOrder: 'number',
...
export const COLS_DIMINISHINGRETURNSDATA = {
  DamageTypeId: 'string',
...
export const COLS_DYNAMICDIFFICULTYSTATICDATA = {
...
export const COLS_FLEXIBLEMISSIONBOARDDATA = {
...
export const COLS_GEARSCOREUPGRADEDEFINITION = {
  Level: 'number',
...
export const COLS_REUSABLESCOREBOARDTABDATA = {
...
export const COLS_WEAPONTIERSDATA = {
  DisplayName: 'string',
  ScalingStart: 'number',
  Tier: 'string',
}
