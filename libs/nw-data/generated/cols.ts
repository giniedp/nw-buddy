...
export const COLS_STATUSEFFECTDATA = {
  ...
  MULTSkinning: "number",
  Mana: "number",
  ManaModifierDamageBased: "string",
  ManaRate: "number",
  MaxGSArcana: "number",
...
export const COLS_STORETAGDATA = {
  ArchetypeId: "string",
